...
export function DashboardPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      const kycData = await riderApi.list({ limit: 1, kyc_status: 'pending' })
      setPendingKycCount(kycData.total)
    } catch (err) {
    ...
    <>
      ...
      <section className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div>
            <p className="stat-val">{loading ? '…' : pendingKycCount}</p>
            <p className="stat-lbl">Pending KYC</p>
          </div>
        </div>
      </section>
                ...
                <tr>
                  <td colSpan={5}>
                    <div className="empty-state">
                      <i className="ri-loader-4-line spin" /> Loading dashboard...
                    </div>
                  </td>
                </tr>
              )}
